...
@protocol SolarDatePickerViewDelegate <NSObject>
...
@interface SolarDatePickerView : UIView
...
@property (weak, nonatomic) id <SolarDatePickerViewDelegate> delegate;
